...
<head>
  <!-- Title -->
  <title>Classic Analytics | Front - Responsive Website Template</title>
  ...
  <link rel="stylesheet" href="front-v3.2.2/assets/vendor/font-awesome/css/all.min.css">
  <link rel="stylesheet" href="front-v3.2.2/assets/vendor/hs-mega-menu/dist/hs-mega-menu.min.css">
  <link rel="stylesheet" href="front-v3.2.2/assets/vendor/fancybox/dist/jquery.fancybox.min.css">
  <link rel="stylesheet" href="front-v3.2.2/assets/vendor/aos/dist/aos.css">

  <!-- CSS Front Template -->
  <link rel="stylesheet" href="front-v3.2.2/assets/css/theme.css">
</head>
<body>
  <!-- ========== HEADER ========== -->
      ...
      <div id="logoAndNav" class="container">
        ...
        <nav class="js-mega-menu navbar navbar-expand-lg">
          ...
          <a class="navbar-brand" href="index.html" aria-label="Front">
            <img src="front-v3.2.2/assets/svg/logos/logo.svg" alt="Logo">
          </a>
          <!-- End Logo -->
                ...
                <li class="hs-has-mega-menu navbar-nav-item">
                  ...
                  <div class="hs-mega-menu dropdown-menu w-100" aria-labelledby="homeMegaMenu">
                    <div class="row no-gutters">
                      <div class="col-lg-6">
                        <!-- Banner Image -->
                        <div class="navbar-banner" style="background-image: url(front-v3.2.2/assets/img/750x750/img1.jpg);">
                  ...
                  <div class="hs-mega-menu dropdown-menu" aria-labelledby="shopMegaMenu">
                    ...
                    <div class="navbar-product-banner">
                      <div class="d-flex align-items-end">
                        <img class="img-fluid mr-4" src="front-v3.2.2/assets/img/mockups/img4.png" alt="Image Description">
                      ...
                      <div class="col-lg-8">
                        <div class="navbar-promo-card-deck">
                          ...
                          <div class="navbar-promo-card navbar-promo-item">
                            <a class="navbar-promo-link" href="../course/index.html">
                              <div class="media align-items-center">
                                <img class="navbar-promo-icon" src="front-v3.2.2/assets/svg/icons/icon-67.svg" alt="SVG">
                          ...
                          <div class="navbar-promo-card navbar-promo-item">
                            <a class="navbar-promo-link" href="../app-marketplace/index.html">
                              <div class="media align-items-center">
                                <img class="navbar-promo-icon" src="front-v3.2.2/assets/svg/icons/icon-45.svg" alt="SVG">
                                <div class="media-body">
                        ...
                        <div class="navbar-promo-card-deck">
                          ...
                          <div class="navbar-promo-card navbar-promo-item">
                            <a class="navbar-promo-link" href="../help-desk/index.html">
                              <div class="media align-items-center">
                                <img class="navbar-promo-icon" src="front-v3.2.2/assets/svg/icons/icon-4.svg" alt="SVG">
                                <div class="media-body">
                          ...
                          <div class="navbar-promo-card navbar-promo-item">
                            <a class="navbar-promo-link disabled" href="javascript:;">
                              <div class="media align-items-center">
                                <img class="navbar-promo-icon" src="front-v3.2.2/assets/svg/icons/icon-13.svg" alt="SVG">
                                <div class="media-body">
                        ...
                        <div class="navbar-promo-card-deck">
                          ...
                          <div class="navbar-promo-card navbar-promo-item">
                            <a class="navbar-promo-link disabled" href="javascript:;">
                              <div class="media align-items-center">
                                <img class="navbar-promo-icon" src="front-v3.2.2/assets/svg/icons/icon-19.svg" alt="SVG">
                                <div class="media-body">
                          ...
                          <div class="navbar-promo-card navbar-promo-item">
                            <a class="navbar-promo-link disabled" href="javascript:;">
                              <div class="media align-items-center">
                                <img class="navbar-promo-icon" src="front-v3.2.2/assets/svg/icons/icon-28.svg" alt="SVG">
                                <div class="media-body">
                      ...
                      <div class="col-lg-4 navbar-promo d-none d-lg-block">
                        <a class="d-block navbar-promo-inner" href="#">
                          <div class="position-relative">
                            <img class="img-fluid rounded mb-3" src="front-v3.2.2/assets/img/380x227/img1.jpg" alt="Image Description">
                          </div>
                  ...
                  <div class="hs-mega-menu dropdown-menu" aria-labelledby="docsMegaMenu" style="min-width: 330px;">
                    ...
                    <div class="navbar-promo-item">
                      <a class="navbar-promo-link" href="../../documentation/index.html">
                        <div class="media align-items-center">
                          <img class="navbar-promo-icon" src="front-v3.2.2/assets/svg/icons/icon-2.svg" alt="SVG">
                          <div class="media-body">
                    ...
                    <div class="navbar-promo-item">
                      <a class="navbar-promo-link" href="../../snippets/index.html">
                        <div class="media align-items-center">
                          <img class="navbar-promo-icon" src="front-v3.2.2/assets/svg/icons/icon-1.svg" alt="SVG">
                          <div class="media-body">
        ...
        <div class="transform-rotate-5">
          <div class="d-none d-lg-flex flex-lg-wrap align-items-lg-end position-absolute top-0 left-50 transform-rotate-6" style="width: 45rem;">
            ...
            <div class="device device-horizontal-ipad mr-4 mb-4" style="width: 23rem;" data-aos="fade-up" data-aos-delay="150" data-aos-offset="-300">
              <img class="device-horizontal-ipad-frame" src="front-v3.2.2/assets/svg/components/ipad-horizontal.svg" alt="Image Description">
              <img class="device-horizontal-ipad-screen" src="front-v3.2.2/assets/img/1618x1010/img1.jpg" alt="Image Description">
            </div>
            <!-- End Device Mockup -->

            <!-- Device Mockup -->
            <div class="device device-ipad mb-4" style="width: 19rem;" data-aos="fade-up">
              <img class="device-ipad-frame" src="front-v3.2.2/assets/svg/components/ipad.svg" alt="Image Description">
              <img class="device-ipad-screen" src="front-v3.2.2/assets/img/533x711/img2.jpg" alt="Image Description">
            </div>
            <!-- End Device Mockup -->
            ...
            <div class="device device-iphone-x align-self-start" style="width: 7rem;" data-aos="fade-up" data-aos-delay="250" data-aos-offset="-300">
              <img class="device-iphone-x-frame" src="front-v3.2.2/assets/svg/components/iphone-x.svg" alt="Image Description">
              <img class="device-iphone-x-screen" src="front-v3.2.2/assets/img/407x867/img8.jpg" alt="Image Description">
            </div>
            <!-- End Device Mockup -->

            <!-- Device Mockup -->
            <div class="device mr-4" style="width: 35rem;" data-aos="fade-up" data-aos-delay="200" data-aos-offset="-300">
              <img class="img-fluid" src="front-v3.2.2/assets/svg/components/macbook.svg" alt="Image Description">
              <img class="device-macbook-screen" src="front-v3.2.2/assets/img/1618x1010/img2.jpg" alt="Image Description">
            </div>
            <!-- End Device Mockup -->
            ...
            <figure class="max-w-23rem w-100 position-absolute bottom-0 left-0 z-index-n1" data-aos="fade-up" data-aos-delay="300" data-aos-offset="-400">
              <div class="mb-n7 ml-n11">
                <img class="img-fluid" src="front-v3.2.2/assets/svg/components/abstract-shapes-10.svg" alt="Image Description">
              </div>
            </figure>
            <!-- End SVG Shape -->
          </div>
          ...
          <a class="card card-bg-light h-100 shadow-none overflow-hidden transition-3d-hover" href="#">
            <div class="row align-items-center">
              ...
              <div class="col-4 col-md-6 px-0">
                <img class="img-fluid" src="front-v3.2.2/assets/svg/illustrations/apps.svg" alt="SVG">
              </div>
            </div>
          </a>
          <!-- End Card -->
        ...
        <div class="col-md-6 col-lg-4 mb-3 mb-lg-0">
          ...
          <a class="card card-bg-light h-100 shadow-none overflow-hidden transition-3d-hover" href="#">
            <div class="row align-items-center">
              ...
              <div class="col-4 col-md-6 px-0">
                <img class="img-fluid" src="front-v3.2.2/assets/svg/illustrations/calendar.svg" alt="SVG">
              </div>
            </div>
          </a>
          <!-- End Card -->
        ...
        <div class="col-md-6 col-lg-4">
          ...
          <a class="card card-bg-light h-100 shadow-none overflow-hidden transition-3d-hover" href="#">
            <div class="row align-items-center">
              ...
              <div class="col-4 col-md-6 px-0">
                <img class="img-fluid" src="front-v3.2.2/assets/svg/illustrations/communication.svg" alt="SVG">
              </div>
            </div>
          </a>
          <!-- End Card -->
          ...
          <div class="col-lg-6 mb-9 mb-lg-0">
            ...
            <div class="position-relative max-w-40rem mx-auto">
              <div class="device device-iphone-x w-85 mx-auto">
                <img class="device-iphone-x-frame" src="front-v3.2.2/assets/svg/components/iphone-x.svg" alt="Image Description">
                <img class="device-iphone-x-screen" src="front-v3.2.2/assets/img/407x867/img1.jpg" alt="Image Description">
              </div>

              <div class="position-absolute top-0 right-0 z-index-2 max-w-33rem mr-n11 mt-9">
                <img class="img-fluid shadow-lg rounded" src="front-v3.2.2/assets/img/407x115/img1.jpg" alt="Image Description">
              </div>
              <div class="position-absolute bottom-0 left-0 z-index-2 max-w-33rem ml-n10 mb-10">
                <img class="img-fluid shadow-lg rounded" src="front-v3.2.2/assets/img/480x320/img26.jpg" alt="Image Description">
              </div>

              <div class="position-absolute bottom-0 right-0 max-w-50rem w-100 z-index-n1 mx-auto">
                <img class="img-fluid" src="front-v3.2.2/assets/svg/components/abstract-shapes-3.svg" alt="Image Description">
              </div>
            </div>
            <!-- End Mockups -->
          </div>
            ...
            <ul class="step step-dashed mb-7">
              <li class="step-item">
                <div class="step-content-wrapper">
                  ...
                  <div class="step-content">
                    <h3 class="h4">Industry-leading documentation</h3>
                    <p><a href="../../documentation/index.html">Our documentation</a> and extensive Client libraries contain everything a business needs to build a custom integration in a fraction of the time.</p>
                  </div>
                 </div>
              </li>
              <li class="step-item mb-0">
                <div class="step-content-wrapper">
                  ...
                  <div class="step-content">
                    <h4>Support for the developer community</h4>
      ...
      <div class="container space-bottom-2">
        <div class="position-relative">
          <div class="bg-light text-center rounded p-4 p-md-7">
            <div class="mb-4">
              <img class="max-w-11rem max-w-md-13rem mx-auto" src="front-v3.2.2/assets/svg/clients-logo/airbnb-original.svg" alt="SVG Logo">
            </div>
          ...
          <figure class="max-w-15rem w-100 position-absolute bottom-0 left-0">
            <div class="mb-n7 ml-n7">
              <img class="img-fluid" src="front-v3.2.2/assets/svg/components/dots-1.svg" alt="Image Description">
            </div>
          </figure>
          <!-- End SVG Element -->
        </div>
        ...
        <div class="row justify-content-lg-between">
          <div class="col-lg-5 mb-9 mb-lg-0">
            <div class="max-w-19rem mb-4">
              <img class="img-fluid" src="front-v3.2.2/assets/svg/illustrations/app-wreath.svg" alt="SVG">
            </div>
            ...
            <div class="row">
              <div class="col-sm-6 mb-5 mb-sm-0">
                ...
                <a class="d-block" href="#" data-aos="fade-left" data-aos-delay="100">
                  <img class="img-fluid w-100 rounded" src="front-v3.2.2/assets/img/400x500/img26.jpg" alt="Image Description">
              ...
              <div class="col-sm-6">
                ...
                <a class="d-block" href="#" data-aos="fade-left">
                  <img class="img-fluid w-100 rounded" src="front-v3.2.2/assets/img/400x500/img25.jpg" alt="Image Description">
                  <div class="shadow-none py-4">
          ...
          <div class="col-lg-3 ml-lg-auto mb-5 mb-lg-0">
            ...
            <div class="mb-4">
              <a href="index.html" aria-label="Front">
                <img class="brand" src="front-v3.2.2/assets/svg/logos/logo-white.svg" alt="Logo">
              </a>
            </div>
            <!-- End Logo -->
              ...
              <li class="list-inline-item">
                <div class="hs-unfold">
                  <a class="js-hs-unfold-invoker dropdown-toggle btn btn-xs btn-soft-light" href="javascript:;"
                    ...
                    <img class="dropdown-item-icon" src="front-v3.2.2/assets/vendor/flag-icon-css/flags/4x3/us.svg" alt="United States Flag">
  ...
  <script src="front-v3.2.2/assets/vendor/jquery/dist/jquery.min.js"></script>
  <script src="front-v3.2.2/assets/vendor/jquery-migrate/dist/jquery-migrate.min.js"></script>
  <script src="front-v3.2.2/assets/vendor/bootstrap/dist/js/bootstrap.bundle.min.js"></script>

  <!-- JS Implementing Plugins -->
  <script src="front-v3.2.2/assets/vendor/hs-header/dist/hs-header.min.js"></script>
  <script src="front-v3.2.2/assets/vendor/hs-go-to/dist/hs-go-to.min.js"></script>
  <script src="front-v3.2.2/assets/vendor/hs-unfold/dist/hs-unfold.min.js"></script>
  <script src="front-v3.2.2/assets/vendor/hs-mega-menu/dist/hs-mega-menu.min.js"></script>
  <script src="front-v3.2.2/assets/vendor/fancybox/dist/jquery.fancybox.min.js"></script>
  <script src="front-v3.2.2/assets/vendor/appear.js"></script>
  <script src="front-v3.2.2/assets/vendor/circles/circles.min.js"></script>
  <script src="front-v3.2.2/assets/vendor/aos/dist/aos.js"></script>

  <!-- JS Front -->
  <script src="front-v3.2.2/assets/js/hs.core.js"></script>
  <script src="front-v3.2.2/assets/js/hs.fancybox.js"></script>
  <script src="front-v3.2.2/assets/js/hs.circles.js"></script>
  ...
  <!-- IE Support -->
  <script>
    if (/MSIE \d|Trident.*rv:/.test(navigator.userAgent)) document.write('<script src="front-v3.2.2/assets/vendor/polifills.js"><\/script>');
  </script>
</body>
</html>
